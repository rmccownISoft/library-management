	...
	<div class="mb-6">
		...
		<div class="flex gap-2 mb-3">
			...
			<label
				...
				onclick={(e) => {
					// Some browsers (notably older Safari/WebKit) don't reliably forward a
					// label click to a file input hidden via `sr-only` clipping. Open it
					// explicitly from the user gesture; preventDefault avoids a double-fire.
					e.preventDefault();
					document.getElementById('toolFiles')?.click();
				}}
			>
