...
CREATE TABLE "new_patrons" (
    ...
    "userAgreementSigned" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_patrons" ("active", "blocked", "createdAt", "createdBy", "damageCount", "email", "firstName", "id", "lastName", "mailingCity", "mailingState", "mailingStreet", "mailingZipcode", "overdueCount", "phone", "updatedAt") SELECT "active", "blocked", "createdAt", "createdBy", "damageCount", "email", "firstName", "id", "lastName", "mailingCity", "mailingState", "mailingStreet", "mailingZipcode", "overdueCount", "phone", "updatedAt" FROM "patrons";
DROP TABLE "patrons";
